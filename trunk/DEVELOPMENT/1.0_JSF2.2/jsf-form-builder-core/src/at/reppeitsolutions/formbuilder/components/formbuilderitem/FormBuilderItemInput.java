 ...
 */
@Entity
public class FormBuilderItemInput extends FormBuilderItemBase implements Serializable {
    
    public FormBuilderItemInput() {
        formbuildertype = FormBuilderItemFactory.TYPE_INPUT;
