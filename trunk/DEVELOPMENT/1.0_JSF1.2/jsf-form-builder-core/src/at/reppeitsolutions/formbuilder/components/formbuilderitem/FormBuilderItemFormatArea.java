 ...
 */
@Entity
public class FormBuilderItemFormatArea extends FormBuilderItemBase {
    
    public FormBuilderItemFormatArea() {
        formbuildertype = FormBuilderItemFactory.TYPE_FORMATAREA;
        properties = new FormBuilderItemProperties();
        properties.setValues(getDefaultValues());
        
        addPropertyTranslation("values", Messages.getStringJSF("formatarea.values"));
    }
    
    public FormBuilderItemFormatArea(boolean renderDescription) {
        this();
        properties.setRenderDescription(renderDescription);
    }
    
    public static String getDefaultValues() {
        return Messages.getStringJSF("HtmlFormBuilderFormatArea");
    }
