 ...
 */
@Entity
public class FormBuilderItemRadio extends FormBuilderItemBase implements Serializable {
    
    public FormBuilderItemRadio() {
        formbuildertype = FormBuilderItemFactory.TYPE_RADIO;
    ...
    public FormBuilderItemRadio(boolean renderDescription) {
        this();
