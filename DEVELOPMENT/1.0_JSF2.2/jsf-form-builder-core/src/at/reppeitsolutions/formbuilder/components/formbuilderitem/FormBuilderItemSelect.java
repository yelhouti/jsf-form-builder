 ...
 */
@Entity
public class FormBuilderItemSelect extends FormBuilderItemBase implements Serializable {
    
    public FormBuilderItemSelect() {
        formbuildertype = FormBuilderItemFactory.TYPE_SELECT;
