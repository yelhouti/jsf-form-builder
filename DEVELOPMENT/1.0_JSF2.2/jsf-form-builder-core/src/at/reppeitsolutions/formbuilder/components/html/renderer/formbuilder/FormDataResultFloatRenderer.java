 ...
 */
@FacesRenderer(componentFamily = FormDataResultFloatRenderer.FAMILY, rendererType = FormDataResultFloatRenderer.RENDERTYPE)
public class FormDataResultFloatRenderer extends Renderer {
    
    public static final String RENDERTYPE = "FormDataResultFloatRenderer";
