 ...
 */
public class PdfFormBuilderInput extends PdfFormBuilderItem {

    public PdfFormBuilderInput() {
    ...
    public Element render() {
        ...
        innerTable.getContent().setCellEvent(new ITextInputText(getProperties().getValues()));
        innerTable.addCells();
        return innerTable;
    }
