 ...
 */
@Entity
public class FormBuilderItemHorizonalRule extends FormBuilderItemBase {
    
    public FormBuilderItemHorizonalRule() {
        formbuildertype = FormBuilderItemFactory.TYPE_HR;
    }
    
    public FormBuilderItemHorizonalRule(boolean renderDescription) {
        this();
